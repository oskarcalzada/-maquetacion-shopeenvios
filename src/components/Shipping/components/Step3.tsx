...
import { Button, Chip, Divider, FormControl, IconButton, InputAdornment, InputLabel, MenuItem, Select, TextField } from "@mui/material";
                ...
                <div className='input_group'>
                    ...
                    <div className="input_row">
                        <ISwitch 
                            ...
                            checked={formValues.packageInfo.insurePackage}
                            onChange={(e: any) => updatePackageInfo("insurePackage", e.target.checked)}
                            name="insurePackage"
                        />
                        {formValues.packageInfo.insurePackage && (
                            <TextField
                                label="Valor"
                                variant="outlined"
                                name="insuranceValue"
                                fullWidth
                                type="number"
                                value={formValues.packageInfo.insuranceValue}
                                onChange={(e) => updatePackageInfo("insuranceValue", e.target.value)}
                                required
                                error={errors.insuranceValue === true}
                            />
                        )}
                    </div>
                    <div>
